...
public class ProviderClientService {
    ...
    private String providerServiceUrl; // e.g. http://localhost:9091/providers

    @Autowired
    private RestTemplate restTemplate;

    public ProviderDTO fetchProviderByHosId(String hosId) {
        String url = providerServiceUrl + "/" + hosId;
