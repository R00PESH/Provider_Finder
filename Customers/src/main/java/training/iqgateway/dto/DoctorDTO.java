...
public class DoctorDTO {
    ...
    private GeoJsonPoint hospitalLocationPoint;
	...
	public GeoJsonPoint getHospitalLocationPoint() {
		return hospitalLocationPoint;
	}



	public void setHospitalLocationPoint(GeoJsonPoint hospitalLocationPoint) {
	...
	public DoctorDTO(String id, String docId, String hosId, String name, String licenseNumber, String qualification,
			...
			List<ReviewDTO> reviews, Double rating, String hospitalName, String hospitalLocation,Double hospitalLat,Double hospitalLon,GeoJsonPoint hospitalLocationPoint) {
		super();
		this.id = id;
		this.docId = docId;
		this.hosId = hosId;
