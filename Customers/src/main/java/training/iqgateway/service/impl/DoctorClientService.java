...
//		    }
		    ...
		    System.out.println("Sending to Doctor-MS: [" + availabilityStatus + "]");
		    System.out.println("URL: " + builder.toUriString());
	...
	public DoctorDTO addReview(String docId, DoctorDTO.ReviewDTO reviewDTO) {
	    String url = UriComponentsBuilder
	        .fromHttpUrl(doctorServiceUrl + "/" + docId + "/reviews")
	        .toUriString();
	    return restTemplate.postForObject(url, reviewDTO, DoctorDTO.class);
	}
