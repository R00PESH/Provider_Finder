...
public class CustomerDTO {
    ...
    public CustomerDTO(String id, String name, String email, String password, Instant dateOfBirth, String gender,
    ...
    public String getNomineeAdharNumber() { return nomineeAdharNumber; }
    public void setNomineeAdharNumber(String nomineeAdharNumber) { this.nomineeAdharNumber = nomineeAdharNumber; }
    ...
    public String toString() {
        return "CustomerDTO [id=" + id + ", name=" + name + ", email=" + email + ", password=" + password
            ...
            + ", contactNumber=" + contactNumber + ", address=" + address + ", zipcode=" + zipcode
            + ", lat=" + lat + ", lon=" + lon + ", nominee=" + nominee + ", nomineeAdharNumber=" + nomineeAdharNumber
            + ", insurancePlans=" + insurancePlans + ", status=" + status
            + ", geoLocation=" + geoLocation + "]";
    }

    // --- Inner POJO for GeoLocation ---
    public static class GeoLocationDTO {
        ...
        public GeoLocationDTO(String type, List<Double> coordinates) {
            this.type = type;
        ...
        @Override
        public String toString() {
            return "GeoLocationDTO{type='" + type + "', coordinates=" + coordinates + '}';
        }
    }
}
